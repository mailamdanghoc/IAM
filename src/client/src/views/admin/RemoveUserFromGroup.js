...
const RemoveUserFromGroup = () => {
  ...
  useEffect(() => {
    const fetchGroups = async () => {
        try {
            const response = await axios.get(`http://localhost:9000/api/admin/getUserGroupToModify/${uid}?getgroup=${false}`,
                {
  ...
  return (
    <div className="container mx-auto mt-8">
      <h1 className="text-2xl font-semibold mb-4">Remove Role Of User</h1>
